...
{
  echo "<style>.elsm-debug{background:honeydew;padding:1rem;position:relative;z-index:99999;display:inline-block}.admin-debug-row h3{color:darkgray;font-weight:medium}.details{color:teal;font-size:1.4rem;font-weight:bold}</style>";
  $guests_query = new WP_Query(['post_type' => 'guests', 'posts_per_page' => -1, 'orderby' => 'guest_video_count DESC']);
  echo "<section class='elsm-debug'>";
